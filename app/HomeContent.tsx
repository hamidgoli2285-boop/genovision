  ...
  return (
    <>
        ...
        <div className="container-x relative grid gap-10 pb-16 pt-12 sm:pt-16 lg:grid-cols-12 lg:gap-12 lg:pb-24 lg:pt-20">
          <div className="lg:col-span-7 xl:col-span-7">
            ...
            <p className="mt-5 max-w-2xl text-lg leading-relaxed text-ink-muted">
              {t.home.heroDescPart1}
              <strong className="font-semibold text-navy">
                {t.home.heroDesc161}
              </strong>
              {t.home.heroDescPart2}
            </p>
      ...
      <section className="container-x mt-16 lg:mt-24">
        <SectionHeader
          eyebrow={t.home.sectionWhyEyebrow}
          title={
            <>
              {t.home.sectionWhyTitleA} <br className="hidden sm:inline" />
              {t.home.sectionWhyTitleB}
            </>
          }
          description={t.home.sectionWhyDesc}
        />
      ...
      <section className="mt-20 lg:mt-28">
        <ContactCTA
          ...
          secondaryLabel={t.home.finalSecondary}
